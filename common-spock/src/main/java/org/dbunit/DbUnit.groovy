 ...
 * <pre>
 ...
 DataSource dataSource{@literal @}DbUnit
 def content =  {
...
public @interface DbUnit {
     ...
     */
    Class datasourceProvider() default Object.class;
     ...
     * @see org.dbunit.IDatabaseTester* @see org.dbunit.operation.DatabaseOperation* @see org.dbunit.AbstractDatabaseTester#setUpOperation
     * @see org.dbunit.AbstractDatabaseTester#tearDownOperation
     * @see org.dbunit.dataset.ReplacementDataSet
     */
    Class configure() default Object.class;
